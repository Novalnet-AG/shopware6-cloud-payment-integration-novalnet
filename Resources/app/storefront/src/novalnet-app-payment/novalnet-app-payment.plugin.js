        ...
        this._createScript((function() {
            ...
            fetch("https://extapi.novalnet.de/shopware/public/nn/loadIframe", {
                ...
                body: JSON.stringify({
                    ...
                    salesChannelId: document.querySelector("#salesChannelId").value,
                    amount: document.querySelector("#nnAmount").value,
                    billingAddressId: (document.querySelector("#billingAddressId") != null) ? document.querySelector("#billingAddressId").value : null,
                    shippingAddressId: (document.querySelector("#shippingAddressId") != null) ? document.querySelector("#shippingAddressId").value : null,
                    orderId: (document.querySelector("#orderId") != null) ? document.querySelector("#orderId").value : null,
